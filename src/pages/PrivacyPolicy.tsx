  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p>
          All third-party providers are obligated to keep your data secure and confidential.
        </p>
      </>
    )
  },
  ...
  <section className="min-h-screen bg-[#fff7f2] text-[#0A1D37] py-20 px-4">
    <div className="max-w-3xl mx-auto">
      <div className="text-center mb-16">
        ...
        <p className="text-lg text-[#d35400] max-w-xl mx-auto">Your privacy matters. Please read our policy below.</p>
      </div>
