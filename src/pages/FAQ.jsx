    ...
    },
    {
      ...
      faqs: [
        ...
        },
        {
          ...
          answer: "We accept all major credit cards, PayPal, bank transfers, and checks. Payment is typically due 50% upfront and 50% upon delivery of the completed estimate. We also offer payment plans for large projects."
        }
      ]
    },
    {
      ...
      faqs: [
        {
          ...
          answer: "We need architectural drawings, specifications, project location, timeline, and any special requirements. For basic estimates, even rough sketches or plans work. The more detailed information you provide, the more accurate our estimate will be."
        },
        {
    ...
    },
    {
      ...
      faqs: [
        ...
        },
        {
          ...
          answer: "All estimates are delivered digitally in PDF format with detailed Excel spreadsheets. We also provide CAD takeoff files, quantity schedules, and any supporting documentation you need for your project."
        },
        {
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-yellow-50 rounded-lg p-6">
              ...
              <a href="mailto:info@geniousestimate.com" className="text-yellow-600 font-semibold hover:text-yellow-700">
                info@geniousestimate.com
              </a>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">Helpful guides and information for construction professionals</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-sm p-6 hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-semibold mb-3">Estimating Guide</h3>
              <p className="text-gray-600 mb-4">Complete guide to construction cost estimation best practices.</p>
              <button className="text-red-600 font-semibold hover:text-red-700">Download PDF →</button>
            </div>
            
            <div className="bg-white rounded-lg shadow-sm p-6 hover:shadow-lg transition-shadow">
              <DollarSign className="w-8 h-8 text-red-600 mb-4" />
              <h3 className="text-xl font-semibold mb-3">Pricing Calculator</h3>
              <p className="text-gray-600 mb-4">Interactive tool to estimate project costs and get instant quotes.</p>
              <button className="text-red-600 font-semibold hover:text-red-700">Try Calculator →</button>
            </div>
            
            <div className="bg-white rounded-lg shadow-sm p-6 hover:shadow-lg transition-shadow">
              <HelpCircle className="w-8 h-8 text-red-600 mb-4" />
              <h3 className="text-xl font-semibold mb-3">Sample Reports</h3>
              <p className="text-gray-600 mb-4">View examples of our detailed estimation reports and deliverables.</p>
              <button className="text-red-600 font-semibold hover:text-red-700">View Samples →</button>
            </div>
          </div>
        </div>
      </section>
