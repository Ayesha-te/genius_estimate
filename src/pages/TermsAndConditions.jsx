...
const sections = [
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p>
          If you believe there is an issue with the quality or accuracy of your estimate, please contact us at <a href="mailto:support@geniusestimate.com" className="text-red-600 font-semibold">support@geniusestimate.com</a>, and we’ll work to resolve it promptly.
        </p>
      </>
    ),
  },
  ...
  },
  {
    ...
    content: (
      <p>
        Our total liability shall not exceed the amount paid for the estimate.
      </p>
    ),
  },
  {
...
const TermsAndConditions = () => (
  <section className="min-h-screen bg-[#fff7f2] text-[#0A1D37] py-20 px-4">
    <div className="max-w-3xl mx-auto">
      <div className="text-center mb-16">
        <h1 className="text-5xl font-bold mb-6 bg-gradient-to-r from-red-600 to-yellow-500 bg-clip-text text-transparent">
          Terms & Conditions
        </h1>
        <p className="text-lg text-[#d35400] max-w-xl mx-auto">Please read our terms carefully before using our services.</p>
      </div>
      <div className="bg-white rounded-3xl shadow-lg p-8 space-y-12">
        {sections.map((section, idx) => (
          <div key={idx} className="space-y-3">
            {section.title ? (
              <h2 className="text-2xl font-extrabold text-[#d35400] mb-2">{section.title}</h2>
            ) : null}
